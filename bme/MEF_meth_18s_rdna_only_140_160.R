...
fd <- '/data/Blizard-Rakyan/Selin/projects/MEF_SD_DEC/RRBS/Data_Novogene/X204SC22010869-Z01-F001/bme_140_160/'
...
write_csv('meth_18s_140_160.csv')

library(readr)
meth_18s_140_160 <- read_csv("meth_18s_140_160.csv")
meth_18s_140_160


meth_18s_140_160_replicate <- meth_18s_140_160 %>%
...
meth_18s_140_160_replicate

meth_18s_140_160_replicate_treatment <- meth_18s_140_160_replicate %>%
