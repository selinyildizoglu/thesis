...
ifd <- '/data/Blizard-Rakyan/Selin/projects/MEF_SD_DEC/RRBS/Data_Novogene/X204SC22010869-Z01-F001/bismark/'
...
methRaw <- methylKit::processBismarkAln( 
  ...
  assembly = "MM10", 
  read.context = "CpG", 
  save.folder = "/data/Blizard-Rakyan/Selin/projects/MEF_SD_DEC/RRBS/Data_Novogene/X204SC22010869-Z01-F001/mk_wg/",
