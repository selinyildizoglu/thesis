...
rdna_fd <- '/data/Blizard-Rakyan/Selin/projects/mouse_strains/WGS_thesis/data/covs_rdna_all/'
exons_fd <- '/data/Blizard-Rakyan/Selin/projects/mouse_strains/WGS_thesis/data/covs_exons_all/'
...
write_csv(depths_cn, '/data/Blizard-Rakyan/Selin/projects/mouse_strains/WGS_thesis/data/cn/cn_all_WGS_thesis.csv')
